...
exports.conectionController = void 0;
const user_repository_1 = require("../repositores/user.repository");
const token_1 = require("../utils/token");
const conectionController = (socket) => __awaiter(void 0, void 0, void 0, function* () {
    const id = socket.id;
...
exports.conectionController = conectionController;
